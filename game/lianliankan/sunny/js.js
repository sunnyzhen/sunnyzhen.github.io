...
function createGame(){
	...
	for(var i=0;i<10;i++){
		...
		for(var j=0;j<10;j++){
			...
			iBlock.style.left=j*sidelength+j+"px";
			iBlock.style.top=i*sidelength+i+"px";
			iBlock.style.background="url(images/"+temArray[k]+".jpg)";
...
function createPathItem(index){
	...
	pathItem.style.left=num1*sidelength+num1+"px";
	pathItem.style.top=num10*sidelength+num10+"px";
