...
/*		var time_delay=Math.random();
	...
	/*function createRipple(x,y){ //增加dom写法，会导致页面渲染刷新
		...
		if(ripple_type){
			var ripple_template="<div class='ripple_hook' style='left:"+p_x+"px; top:"+p_y+"px; -webkit-transform:scale("+num_scale+");'><div class='ripple_wrap ripple_show' style='-webkit-animation-delay:"+time_delay+"s;'><div class='ripple ripple_1' style='-webkit-animation-delay:"+time_delay+"s;'></div><div class='ripple ripple_2' style='-webkit-animation-delay:"+time_delay+"s;'></div><div class='ripple ripple_3' style='-webkit-animation-delay:"+time_delay+"s;'></div><div class='ripple ripple_4' style='-webkit-animation-delay:"+time_delay+"s;'></div></div></div>";
		}else{
